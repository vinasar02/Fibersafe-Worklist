...
# choose any of the user from the list
        choose1 = self.driver.find_element(By.XPATH,"/html/body/div/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div[2]/div[1]/table/tbody/tr[8]")
        choose1.click()
        time.sleep(5)
# back to the list of the worklist
        ...
        backbutton.click()
        time.sleep(5)
        self.driver.find_element_by_xpath("/html/body/div[1]/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div[1]/div/label/input").clear()
        time.sleep(10)
...
# click the search button
        ...
        time.sleep(5)
# choose any of the user from the list
        choose1 = self.driver.find_element(By.XPATH,"/html/body/div/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div[2]/div[1]/table/tbody/tr[10]")
        choose1.click()
...
# choose any of the user from the list
        choose1 = self.driver.find_element(By.XPATH,"/html/body/div/div[2]/div[2]/div[2]/div/div/div[2]/div/div/div[2]/div[1]/table/tbody/tr[4]")
        choose1.click()
        time.sleep(5)
